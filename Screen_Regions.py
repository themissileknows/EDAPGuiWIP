...
class Screen_Regions:
    def __init__(self, screen, templ):
        ...
        self.location_match_thresh = 0.5
        ...
        self.reg['selected_location'] = {'rect': [0.31, 0.41, 0.48, 0.43], 'width': 1, 'height': 1, 'filterCB': self.equalize, 'filter': None} # may have inaccuracies, originally calculated with 2560x1440
